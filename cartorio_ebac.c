...
#include <string.h>//Biblioteca de String
        int registro()
    //função responsável por registrar o usuário na plataforma     
                   {  
    ...
    //Criação de arquivos no banco de dados
                              fprintf(file,cpf);
	...
	//fim da função de registrar no sistema
        ...
        int consulta()
    //função responsável por consultar os dados do usuário    
                   {
    ...
    //abertura de arquivo e o "r" tem o significado de ler,do ingles "read"                          
                             if(file == NULL)
    //função "se" e função "NULL" caso o resultado desejado chegue a ser nulo
                    {
	...
	//fim da criação de variáveis						 
							 ...
							 remove(cpf);
	//coleta e exclusão de dados do sistema
